...
/**this codes will allow user to get even further detail of the post */
let SCREEN_WIDTH = Dimensions.get('window').width
let SCREEN_HEIGHT = Dimensions.get('window').height

/**replace with our own firebase data */
var images = [
  { id: 1, src: require('./img/write_algo.png') },
  { id: 2, src: require('./img/write_algo2.png') },
  { id: 3, src: require('./img/write_algo4.png') },
  { id: 4, src: require('./img/read_algo.png') },
  { id: 5, src: require('./img/fakhrul.jpg')},
